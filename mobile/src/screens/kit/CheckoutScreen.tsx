  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch(API_ROUTES.CREATE_PAYMENT_INTENT, {
        ...
        body: JSON.stringify(1000) // TODO: Reemplazar con el monto real a cobrar (en centavos, ej: 1000 = 10€)
      });
      ...
      if (result.error) {
        ...
        console.log('✅ Pago completado. 🔗 Ver en: https://dashboard.stripe.com/test/payments/' + result.paymentIntent.id);
        // TODO: Llamadas al backend para procesar el pago
