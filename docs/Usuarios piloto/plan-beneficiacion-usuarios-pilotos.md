...
La participación de estos usuarios permitirá comprobar si el modelo de negocio funciona correctamente, detectar posibles problemas de usabilidad dentro de la aplicación y recopilar feedback directo que ayude a mejorar la experiencia de usuario antes de la publicación definitiva del producto. De esta manera, el programa piloto actúa como una fase de validación previa al lanzamiento, reduciendo riesgos y permitiendo realizar ajustes en el sistema antes de su adopción por un mayor número de usuarios.
...
En el caso de los **usuarios arrendatarios**, es decir, aquellos que alquilan kits dentro de la plataforma, se ofrecerá un descuento equivalente al **20 % en su primer alquiler**. Este porcentaje corresponde exactamente a la comisión que normalmente obtendría la plataforma por cada alquiler realizado. Como consecuencia, en la primera transacción realizada por cada usuario piloto la empresa no obtiene beneficio directo, pero a cambio consigue validar el servicio y mejorar el producto a partir de la experiencia de uso real.
...
Según el análisis realizado del mercado, el precio medio de un kit de alquiler de artículos domésticos y servicios básicos se sitúa aproximadamente en **240 €**. Esta estimación se ha tomado como referencia a partir del precio de productos similares como el **Kit Quick Muv**.
