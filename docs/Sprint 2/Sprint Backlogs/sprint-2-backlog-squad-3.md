...
|---|---|---|
| Adrián Chabrera Rubio | [AdrianChabrera](https://github.com/AdrianChabrera) | [adrcharub@alum.us.es](adrcharub@alum.us.es) | 
| Alejandro González Macías | [Ultimate88x](https://github.com/Ultimate88x) | [alegonmac@alum.us.es](mailto:alegonmac@alum.us.es) | 
...
**Objetivo**: Refactorizar las funcionalidades ya implementadas y añadir nuevas funcionalidades ya planeadas.

## 2. Sprint Backlog - Semana 1

| ID Issue | Descripción | Prioridad | Estimación (SP) | Estado | Responsable |
|----------|-------------|-----------|-----------------|--------|-------------|
| [#233](https://github.com/KeaKit/KeaKit/issues/233)  | CU-GENERAL-01 - Testing | Mid |  3  | Done | Marta De la Calle González  |
| [#234](https://github.com/KeaKit/KeaKit/issues/234)  | CU-GENERAL-02 - Testing | Mid |  3  | Done | Marta De la Calle González  |
| [#230](https://github.com/KeaKit/KeaKit/issues/230)  | Refactorizar autenticación y gestión del perfil | High |  5  | Done | Adrián Chabrera Rubio  |
| [#231](https://github.com/KeaKit/KeaKit/issues/231)  | Refactorizar valoraciones | High |  2  | Done | Alejandro González Macías  |
| [#236](https://github.com/KeaKit/KeaKit/issues/236)  | Modelo de team building | Mid |  2  | Done | Guillermo Ciria González  |
...
| [#347](https://github.com/KeaKit/KeaKit/issues/101)  | CU-ARRENDATARIO-10 - Ampliación de búsqueda geográfica (Añadir selección de objeto por mapa) | Mid |  4  | Done |  Rafael Harana Mancilla  |
...
|-------------------|------------------------|------------------------|------------------------|------------------------|
| Adrián Chabrera Rubio | 5 SP | 4 SP |  8 SP  | 17 SP                                       
| Alejandro González Macías | 2 SP |  7 SP |  4 SP  | 13 SP                 
| Guillermo Ciria González * | 2 SP | 2 SP |  1 SP  |  5 SP                
| Marta De la Calle González | 6 SP | 3 SP |  4 SP  |  13 SP                
| Rafael Harana Mancilla | 0 SP | 6 SP |  2 SP  | 8 SP                 
| **TOTAL EQUIPO**   | **15 SP**        |  **22 SP**  |  **19 SP**  |     | 

\* Encargado de tareas de despliegue y presentaciones externas a este Sprint Backlog. Diferencia de SP justificada.

## 6. Historial de versiones

| Versión | Fecha       | Descripción                    | Autor(es)                  |
|---------|-------------|--------------------------------|----------------------------|
| 1.0.0   | 18/03/2026  |  Sprint Backlog Semanas 1 y 2              | Adrián Chabrera Rubio |
| 2.0.0   | 21/03/2026  |  Sprint Backlog inicial Semana 3 | Adrián Chabrera Rubio
| 2.0.1 | 24/03/2026 | Tareas añadidas semana 3 | Adrián Chabrera Rubio
