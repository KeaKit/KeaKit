...
* **CU-GENERAL-06** – Descuentos según nivel de usuario piloto: Aplica reducciones en las tarifas de servicio basadas en el historial y la reputación de los usuarios participantes en la fase inicial.
...
* **CU-ARRENDADOR-11** – Descuento según nivel de usuario piloto: Permite a los arrendadores de la fase piloto acceder a bonificaciones en las comisiones de publicación según su nivel de actividad.
...
* **CU-ARRENDATARIO-12** – Descuento según nivel de usuario piloto: Ofrece precios especiales y cupones de descuento a los arrendatarios que alcancen hitos específicos durante el periodo piloto.
...
* **CU-ADMIN-07** – Sistema de recompensas para usuarios piloto: Define y gestiona las reglas de asignación de puntos, insignias o beneficios exclusivos para los usuarios que participan en la beta del sistema.
