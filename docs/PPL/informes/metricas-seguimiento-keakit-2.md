...
6. [Engagement en Instagram](#6-engagement-en-instagram)
   ...
   - 6.4. [Conclusiones](#64-conclusiones)
...
8. [Engagement en X](#8-engagement-en-x)
   - 8.1. [Métricas generales](#81-métricas-generales)
9. [Engagement TikTok](#9-engagement-tiktok)
   - 9.1. [Métricas generales](#91-métricas-generales)
   - 9.2. [Rendimiento por publicación](#92-rendimiento-por-publicación)
   - 9.3. [Indicadores](#93-indicadores)
   - 9.4. [Conclusiones](#94-conclusiones)
10. [Comparación entre canales](#10-comparación-entre-canales)
11. [Cuadro de métricas de seguimiento](#11-cuadro-de-métricas-de-seguimiento)
12. [Conclusiones](#12-conclusiones)
13. [Recomendaciones de mejora](#13-recomendaciones-de-mejora)
...
Este informe recopila las métricas disponibles sobre las acciones de marketing de KeaKit y los datos de captación de usuarios piloto. En concreto, se analizan los datos pertenecientes a la fase PPL del proyecto. 

## 2. Fuentes de información y alcance del análisis

El informe se apoya en dos bloques de información. En primer lugar, las métricas de Instagram, LinkedIn, X y TikTok, que incluyen visualizaciones, alcance, interacciones, visitas al perfil, clics en enlaces y nuevos seguidores. En segundo lugar, el documento de usuarios piloto, que registra un total de 61 usuarios captados, distribuidos en cinco fases de captación.
...
| Tasa de respuesta a encuestas | Porcentaje de respuestas obtenidas en encuestas difundidas por mensajería | Número de encuestas resueltas por usuario y total de respuestas | No consta el número exacto total de invitaciones enviadas por mensajería |
| Engagement en redes | Interacciones en Instagram, LinkedIn y X | Interacciones, alcance e impresiones en Instagram, LinkedIn, X y TikTok | Se calcula por separado y con desglose según la red social |

## 4. Tasa de inscripción de usuarios piloto

El documento de usuarios piloto recoge un total de 61 personas registradas. La captación se organiza en cinco fases: una primera fase inicial, una segunda fase vinculada al Feedback Sprint 1, una tercera fase vinculada al Feedback Sprint 2, una cuarta fase vinculada al Feedback Sprint 3 y una quinta fase vinculada al Feedback PPL.

| Fase de captación | Usuarios captados | Porcentaje sobre el total | Arrendatarios | Arrendadores |
|---|---:|---:|---:|---:|
| Primera captación, fase inicial | 16 | 26,23 % | 6 | 10 |
| Segunda captación, Feedback Sprint 1 | 8 | 13,11 % | 6 | 2 |
| Tercera captación, Feedback Sprint 2 | 9 | 14,75 % | 3 | 6 |
| Cuarta captación, Feedback Sprint 3 | 8 | 13,11 % | 4 | 4 |
| Quinta captación, Feedback PPL | 20 | 32,79 % | 13 | 7 |
| **Total** | **61** | **100,00 %** | **32** | **29** |

La quinta fase (Feedback PPL) es la más intensa, con 20 usuarios captados, lo que representa el 32,79 % del total. La primera fase concentra el segundo mayor volumen, con 16 usuarios (26,23 %). Las fases intermedias mantienen una captación más moderada, con entre 8 y 9 usuarios cada una. El repunte en la quinta fase sugiere que las acciones de difusión durante la fase PPL han sido especialmente efectivas para la incorporación de nuevos usuarios piloto.

En términos de rol, el conjunto de usuarios piloto presenta una distribución con ligera mayoría de arrendatarios. Los arrendatarios representan el 52,46 % del total, frente al 47,54 % de arrendadores.

| Rol | Usuarios | Porcentaje |
|---|---:|---:|
| Arrendatario | 32 | 52,46 % |
| Arrendador | 29 | 47,54 % |
| **Total** | **61** | **100,00 %** |
...
En concreto, se han analizado cuatro publicaciones de Instagram:
...
|---|---:|---:|---:|---:|
| Landing Page | 104 | 68 | 2 | 7 |
| Presentación TikTok | 181 | 95 | 2 | 17 |
| Repost reel | 156 | 119 | 9 | - |
| Repost post zodiaco | 83 | 62 | 0 | - |
...
| Métricas totales | Resultado |
|---|---:|
| Impresiones | 218 |
| Miembros alcanzados | 48 |
| Visualizaciones del perfil desde la publicación | 15 |
...
|---|---:|
| Tasa de visualización del perfil sobre impresiones | 6,88 % |
| Tasa de visualización del perfil sobre alcance | 31,25 % |
| Tasa de conversión a seguidores sobre impresiones | 0,92 % |
| Tasa de conversión a seguidores sobre alcance | 4,17 % |
| Conversión de visitas al perfil en seguidores | 13,33 % |
| Tasa de interacción sobre impresiones | 2,75 % |
| Tasa de interacción sobre alcance | 12,50 % |

El volumen absoluto de interacciones sigue siendo moderado, pero las tasas relativas muestran una mejora significativa respecto al periodo anterior. La tasa de visualización del perfil sobre alcance alcanza el 31,25 %, lo que indica que casi un tercio de las personas alcanzadas visitaron el perfil. De las 15 visitas al perfil, 2 se convirtieron en nuevos seguidores, lo que sitúa la conversión de visitas a seguidores en un 13,33 %. Además, la tasa de interacción sobre alcance del 12,50 % refleja un nivel de engagement notable para el volumen de audiencia alcanzado.

### 7.2 Métricas sobre audiencia

En cuanto al perfil de audiencia, los datos disponibles muestran una presencia relevante de Sevilla y alrededores, así como de personas vinculadas al sector del desarrollo de software.

| Categoría | Segmento principal | Porcentaje |
|---|---|---:|
| Nivel de responsabilidad | No disponible | - |
| Ubicación | Sevilla y alrededores | 75 % |
| Sector | Desarrollo de software | 58 % |
| Tamaño de empresa | No disponible | - |

Esta audiencia resulta coherente con un proyecto emergente vinculado al entorno universitario y local. Sin embargo, el objetivo sigue siendo ampliar la captación hacia vecinos, familias, personas trabajadoras o usuarios con objetos disponibles para alquilar. 
...
| Métrica | Resultado |
|---|---:|
| Número de posts publicados | 17 |
| Número de seguidores | 5 |
| Impresiones totales | 61 |
| Likes totales | 1 |
...
|---|---:|
| Impresiones medias por publicación | 3,59 |
| Tasa de engagement sobre impresiones (likes/impresiones) | 1,64 % |
| Tasa de engagement sobre seguidores (likes/seguidores) | 20,00 % |
| Ratio de impresiones por seguidor | 12,20 |

La media de 3,59 impresiones por publicación refleja un alcance muy reducido, lo que indica que los contenidos apenas están siendo distribuidos por el algoritmo de la plataforma. La tasa de engagement sobre impresiones del 1,64 % se sitúa dentro de rangos habituales para cuentas pequeñas, pero el volumen absoluto es insuficiente para generar cualquier tipo de tracción orgánica.

El ratio de 12,20 impresiones por seguidor sugiere que parte de las impresiones proviene de usuarios externos a la cuenta, lo cual es positivo como señal de descubrimiento, aunque el volumen total sigue siendo marginal. La cuenta se encuentra en una fase inicial tras su reactivación, lo que explica en parte estos resultados.

## 9. Engagement TikTok

### 9.1. Métricas generales

La cuenta de TikTok se abrió el 4 de mayo de 2026. Los datos recogidos corresponden a los primeros 8 días de actividad, hasta el 12 de mayo. En ese periodo se han publicado 6 vídeos.
...
El 94 % del tráfico procede del For You Page (FYP), mientras que el 5,1 % llega desde el perfil personal y el 0,6 % desde la búsqueda. Que prácticamente todo el tráfico provenga del FYP indica que el algoritmo está distribuyendo el contenido más allá de los seguidores actuales, lo cual es muy favorable para una cuenta recién creada. Se han conseguido un total de 30 seguidores.

### 9.2. Rendimiento por publicación

| Publicación | Visualizaciones | Likes | Comentarios | Compartidos | Guardados |
|---|---:|---:|---:|---:|---:|
| Post artículo según zodiaco | 298 | 15 | 0 | 1 | 0 |
| Vídeo “Cuando no conoces KeaKit” | 704 | 24 | 2 | 0 | 0 |
| Vídeo presentación | 1.550 | 150 | 13 | 2 | 4 |
| Vídeo explicación KeaKit | 1.112 | 78 | 4 | 3 | 0 |
| Vídeo learning agreement | 1.380 | 96 | 2 | 0 | 5 |
| Vídeo humor CM | 793 | 39 | 0 | 0 | 2 |
| **Total** | **5.837** | **402** | **21** | **6** | **11** |

El vídeo de presentación es la pieza con mejor rendimiento absoluto, concentrando el 26,6 % de las visualizaciones totales y el 37,3 % de los likes. Los tres vídeos con mayor número de vistas superan las 1.000 visualizaciones cada uno, lo que refuerza la conclusión de que el formato de vídeo con persona hablando a cámara es el más efectivo.
...
La comparación entre los cuatro canales muestra diferencias claras en volumen, tipo de interacción y fase de madurez.
...
- LinkedIn: 218 impresiones, 48 miembros alcanzados, 6 interacciones sociales y 2 nuevos seguidores.
...
En Instagram, dado que los reels han demostrado ser el formato más eficaz con diferencia (57,6 % de las visualizaciones), se recomienda mantener y aumentar la frecuencia de publicación de vídeos cortos con persona hablando a cámara. Conviene seguir combinando contenido de humor con contenido informativo, ya que ambos han generado buenos resultados. Las historias, aunque con menor alcance, siguen siendo útiles como herramienta de mantenimiento de comunidad, especialmente cuando incluyen elementos interactivos como sorteos y enlaces.
...
|---------|------------|--------------------------------|------------|
| 1.0.0   | 12/05/2026 | Versión inicial del segundo informe de métricas de seguimiento de marketing (fase PPL) | Rosa María Espinosa Martínez |
