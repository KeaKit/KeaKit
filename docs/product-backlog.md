...
| Tipo | ID                 | Descripción                                                                        | Prioridad | Estimación (SP) | Estado | Sprint asignado |
|------|--------------------|------------------------------------------------------------------------------------|-----------|-----------------|--------|------------------|
| CU   | CU‑GENERAL‑01      | Registro e inicio de sesión  | M | - | Done | S1 |
| CU   | CU‑GENERAL‑02      | Gestión de datos personales | M | - | Done | S1 |
...
| CU   | CU‑ARRENDADOR‑04      | Gestión de fin de alquiler | S | - | Done? | S1 |
| CU   | CU‑ARRENDADOR‑05      | Retirada de ingresos  | C | - | ToDo | S2 |
| CU   | CU‑ARRENDADOR‑06      | Alertas de demanda | C | - | Done? | S2 |
| CU   | CU‑ARRENDADOR‑07      | Filtros en "Mis artículos"  | C | - | In Review | S3 |
...
| CU   | CU‑ARRENDATARIO‑04      | Pago del kit | M | - | Done | S1 |
| CU   | CU‑ARRENDATARIO‑05      | Seguimiento de alquileres activos  | M | - | Done | S1 |
| CU   | CU‑ARRENDATARIO‑06      | Alertas de demanda | C | - | Done? | S2 |
| CU   | CU‑ARRENDATARIO‑07      | Modificar kits predeterminados  | C | - | In Progress | S2 |
| CU   | CU‑ARRENDATARIO‑08      | Filtrado de artículos disponibles | C | - | Done? | S2 |
...
| 2.0.0   | 01/04/2026  | Actualización completa del Product Backlog | Cristina Fernández Chica | 
