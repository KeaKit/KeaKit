...
## Sprint 1: Flujo Principal
**Objetivo:** Establecer la infraestructura base, gestión de identidades y el ciclo completo de catálogo y transacciones (casos de uso core).


| Módulo | Casos de Uso (CU) | Equipo Responsable |
| :--- | :--- | :--- |
| **Gestión de Usuarios** | CU-ARRENDADOR01, CU-ARRENDADOR13 CU-ARRENDATARIO01, CU-ARRENDATARIO02, CU-ARRENDATARIO07, CU-ADMIN03 | Lucía Ponce García de Sola, Miguel Álvarez Raya, Enrique Nicolae Barac Ploae, Salma El Hakimy, Luis Emmanuel Chavez Malave |
...
## Sprint 2: Optimización y Análisis de Demanda
**Objetivo:** Integrar el feedback de usuarios reales y expandir las capacidades de búsqueda y alertas.
...
## Sprint 3: Fidelización y Refinamiento Final
**Objetivo:** Pulir la experiencia de usuario mediante filtros avanzados y sistemas de aviso de disponibilidad.
